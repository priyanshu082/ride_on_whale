...
const Navbar = ({ scrollToKnowledge }) => {
  ...
  return (
    ...
    <nav className="bg-[#E6E6FF] sticky top-0 z-50 w-[100%] h-24 flex flex-row items-center justify-between px-5 sm:px-20">
       ...
       <div className="flex items-center gap-2 md:gap-5">
         {!user ? (
           <Link
             to="/login"
             className="button z-20 py-[1vw] md:py-[0.5vw] flex items-center text-[2vw] md:text-[1vw] rounded-xl px-[2vw] text-white"
           >
             LOG IN
           </Link>
         ) : (
           <Link
             ...
             to="/"
             className="button z-20 py-[1vw] md:py-[0.5vw] flex items-center text-[2.25vw] md:text-[1vw] rounded-xl px-[2vw] text-white"
           >
             LOG OUT
           </Link>
         )}
