                ...
                <div className="contentBox w-[90%] h-auto bg-white rounded-lg px-10 py-5">
                    ...
                    <div className="py-5 text-center  ">
                        ...
                        <ul className="list-disc text-left text-lg  pl-8">
                            ...
                            <li>The application in the prescribed format should be sent to                             <Link to="mailto:contact@rideonwhale.com" className="text-blue-500 underline">contact@rideonwhale.com</Link>
                            </li>
