    ...
    return (
      ...
      <header className="py-5">
        ...
        <p className="text-lg mb-4">
          Hello! I am Amritesh Chauhan, the founder of rideonwhale.com, your ultimate resource for cutting-edge insights and real-time data on options trading. Since our establishment in 2022, we have been committed to empowering option traders with the knowledge, tools, and data they need to excel in the dynamic option trading market.
        </p>
      </header>
          ...
          For more information or to start exploring our resources, visit our website at <a href="https://rideonwhale.com" className="text-blue-600 underline">Rideonwhale.com</a>. Join the Rideonwhale.com community today and take the next step in your trading journey.
                    ...
                    <div className="contactContainer  w-full h-auto flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div className=" p-2 mt-2">
                            ...
                            <ul className="">
                                <li className="text-lg mb-2">Email: <Link to="mailto:contact@rideonwhale.com" className="nav text-blue-600">contact@rideonwhale.com</Link></li>
