...
<div className="my-[20px] flex justify-center ">
      ...
      className="button cursor-pointer w-fit text-[18px] z-20 py-[5px] flex items-center rounded-xl px-[15px] font-semibold text-white">{isDownloading ? 'Downloading...' : 'Download Data'}</button>
      </div>
<div className="">
